          ...
          <ScrollView>
            <View style={{ marginBottom: 10 }}>
              <View style={{ paddingHorizontal: 10, paddingVertical: 10 }}>
                ...
                {allRequisition?.orderSeller?.map(
                  (items: any, indexs: number) => (
                    <View key={indexs}>
                      <View>
                        <View
                          style={[
                          ...
                          <View style={styles.card} key={index}>
                            ...
                            <View style={{ marginTop: 10 }}>
                              <StepIndicator
                                ...
                                currentPosition={
                                  items?.orderSellerStatus == "pending"
                                    ? 0
                                    : items?.orderSellerStatus == "readyToShip"
                                    ? 1
                                    : items?.orderSellerStatus == "onTheWay"
                                    ? 2
                                    : items?.orderSellerStatus == "delivered"
                                    ? 3
                                    : 4
                                }
                                labels={labels}
